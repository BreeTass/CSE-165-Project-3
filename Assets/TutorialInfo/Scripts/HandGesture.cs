...
public class HandGesture : MonoBehaviour
{
    ...
    //// Helps reduce accidental flicking on release
    ...
    //    // Use pinch strength instead of only bool
    //    float pinchStrength =
    //        hand.GetFingerPinchStrength(OVRHand.HandFinger.Index);

    //    bool pinching =
    //        pinchStrength > minPinchStrength;
    ...
    //    bool walkGesture = indexPinch > minPinchStrength;
    //    bool runGesture = middlePinch > minPinchStrength;

    //    if (!walkGesture && !runGesture)
    //    {
    //        lineRenderer.enabled = false;
    //        wasPinching = false;
    //        return;
    ...
    //    agentMovement.SetRunning(runGesture);

    //    Transform wrist = skeleton.Bones[(int)OVRSkeleton.BoneId.XRHand_Wrist].Transform;
    ...
    //    {
    //        tip =
    //            skeleton.Bones[(int)OVRSkeleton.BoneId.XRHand_MiddleTip].Transform;
    //    }
    //    else
    //    {
    //        tip =
